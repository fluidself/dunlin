...
CREATE TABLE public.notes (
  ...
  "content" jsonb NOT NULL, -- encrypted with deck password
  title jsonb NOT NULL, -- encrypted with deck password
...
CREATE TABLE public.decks (
  ...
  -- details is Lit encrypted name and encryption password stored as:
  -- { encryptedString: encryptedStringBase64, encryptedSymmetricKey: encryptedSymmetricKeyBase64, accessControlConditions }
