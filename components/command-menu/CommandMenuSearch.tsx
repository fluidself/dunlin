...
export default function CommandMenuSearch(props: Props) {
  ...
  return (
    <div className="flex flex-col z-30 w-full max-w-2xl bg-white rounded shadow-popover dark:bg-gray-800 border dark:border-gray-700">
      ...
      {options.length > 0 ? (
        <>
          ...
          <div className="flex items-center justify-center text-xs rounded-bl rounded-br select-none text-gray-500 dark:text-gray-300 space-x-6 py-1 font-mono">
            <div>
