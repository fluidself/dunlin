import { type Point, Editor, BaseRange } from 'slate';
...
export function isCursorOnEdgeOfContainer(editor: ReactEditor, container: Point, cursor: Point, edge: ContainerEdge) {
 ...
 */
function getRangeRect(editor: ReactEditor, range: BaseRange) {
